            ...
            <div className='card'>
                <div className="card-header">
                    ...
                    <div className="buttonsContainer">
                        <button className="DelhiEdit" onClick={() => navigate(`/Delhiaddplayer/${_id}`)}>Edit</button>
...
export default Delhiplayerview;
