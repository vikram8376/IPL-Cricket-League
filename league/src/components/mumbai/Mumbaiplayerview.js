...
import './mumbaiplayerview.css';

const Mumbaiplayerview = () => {
            ...
            <div className='card'>
                <div className="card-header">
                    ...
                    <div className="buttonsContainer">
                        <button className="DelhiEdit" onClick={() => navigate(`/mumbaiaaddplayer/${_id}`)}>Edit</button>
...
export default Mumbaiplayerview;
