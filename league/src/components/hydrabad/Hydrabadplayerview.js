...
import './hydrabadplayerview.css';


function Hydrabadplayerview() {
    ...
    <div className='card'>
        <div className="card-header">
            ...
            <div className="buttonsContainer">
                <button className="DelhiEdit" onClick={() => navigate(`/Hydrabadaddplayer/${_id}`)}>Edit</button>
...
export default Hydrabadplayerview;
